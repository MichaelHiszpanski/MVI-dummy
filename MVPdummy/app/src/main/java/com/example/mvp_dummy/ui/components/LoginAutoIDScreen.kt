...
@Composable
fun LoginAutoIDScreen( onLoginClicked: (String) -> Unit, scrollState: ScrollState, navController: NavController) {
...
//            onValueChange = {
//                userEmail = it
//                userEmailError = null  // Reset error on user input
//            },
...
//            modifier = Modifier.fillMaxWidth(),
//            visualTransformation = if (userEmailError != null) VisualTransformation.None else VisualTransformation.None
//        )
